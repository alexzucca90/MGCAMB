...
!! in MG it should be declared as a class inheriting from parametrized_function_2D.
...
module MGCAMB_abstract_parametrizations_2D
    ...
    !! free function in MG it should be declared as a class inheriting from parametrized_function.
    !! This guarantees maximum performances as well as maximum flexibility.
    ...
    contains
        ...
        procedure( ParametrizedFunction2DValue              ), deferred :: value               !< function that returns the value of the function. The MGCAMB cache is passed as an optional argument in case the parametrization uses some background quantity.
        procedure( ParametrizedFunction2DFirstDerivativeX   ), deferred :: first_derivative_x  !< function that returns the first partial derivative of the function with respect to x. The MGCAMB cache is passed as an optional argument in case the parametrization uses some background quantity.
        procedure( ParametrizedFunction2DFirstDerivativeY   ), deferred :: first_derivative_y  !< function that returns the first partial derivative of the function with respect to y. The MGCAMB cache is passed as an optional argument in case the parametrization uses some background quantity.
        procedure( ParametrizedFunction2DSecondDerivativeX  ), deferred :: second_derivative_x !< function that returns the second partial derivative of the function with respect to x. The MGCAMB cache is passed as an optional argument in case the parametrization uses some background quantity.
        procedure( ParametrizedFunction2DSecondDerivativeY  ), deferred :: second_derivative_y !< function that returns the second partial derivative of the function with respect to y. The MGCAMB cache is passed as an optional argument in case the parametrization uses some background quantity.
        procedure( ParametrizedFunction2DSecondDerivativeXY ), deferred :: second_derivative_xy!< function that returns the mixed partial derivative of the function with respect to x and y. The MGCAMB cache is passed as an optional argument in case the parametrization uses some background quantity.
    ...
    abstract interface
        ...
        function ParametrizedFunction2DValue( self, x, y, mg_cache )
            use precision
            use    MGCAMB_cache
            import parametrized_function_2D
            implicit none
        ...
        !! with respect to the first variable. The MGCAMB cache is passed as an optional
        !! argument in case the parametrization uses some background quantity.
        function ParametrizedFunction2DFirstDerivativeX( self, x, y, mg_cache  )
            use    precision
            use    MGCAMB_cache
            import parametrized_function_2D
            implicit none
        ...
        ! ---------------------------------------------------------------------------------------------
        !> Function that returns the value of the first partial derivative of the function
        !! with respect to the second variable. The MGCAMB cache is passed as an optional
        !! argument in case the parametrization uses some background quantity.
        function ParametrizedFunction2DFirstDerivativeY( self, x, y, mg_cache )
            use    precision
            use    MGCAMB_cache
            import parametrized_function_2D
            implicit none
        ...
        !! with respect to the first variable. The MGCAMB cache is passed as an optional
        !! argument in case the parametrization uses some background quantity.
        function ParametrizedFunction2DSecondDerivativeX( self, x, y, mg_cache )
            use    precision
            use    MGCAMB_cache
            import parametrized_function_2D
            implicit none
        ...
        !! with respect to the second variable. The MGCAMB cache is passed as an optional
        !! argument in case the parametrization uses some background quantity.
        function ParametrizedFunction2DSecondDerivativeY( self, x, y, mg_cache )
            use    precision
            use    MGCAMB_cache
            import parametrized_function_2D
            implicit none
        ...
        !! with respect to the first and second variable. The MGCAMB cache is passed as an optional
        !! argument in case the parametrization uses some background quantity.
        function ParametrizedFunction2DSecondDerivativeXY( self, x, y, mg_cache )
            use    precision
            use    MGCAMB_cache
            import parametrized_function_2D
            implicit none
...
end module MGCAMB_abstract_parametrizations_2D
