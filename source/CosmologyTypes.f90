    ...
    !systematics parameters
        real(mcp) :: m0, m1 !multiplicative bias parameters
        real(mcp) :: etas, thetas !additive bias typical scales
        real(mcp) :: f010, f011, f020, f021, f110, f111, f120, f121 !additive bias redshift dependent coefficient
        real(mcp) :: c01, c02, c11, c12 !additive bias redshift dependent amplitudes
    !----------------------
    end Type CMBParams
